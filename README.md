...
- Regras de negócio;
- Validação de dados;
- Gerenciamento de estados das entidades;
- Separação de responsabilidades;
- Organização e arquitetura de código;
- Boas práticas de desenvolvimento em Java.

Atualmente, o projeto utiliza Java 21 e Maven, com os dados armazenados em memória, sem utilização de frameworks ou banco de dados externo.
Essa abordagem permite concentrar o aprendizado inicialmente na construção da lógica da aplicação, no comportamento das entidades e na separação entre as diferentes responsabilidades do sistema.
